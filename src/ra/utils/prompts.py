...
from ra.core.types import QueryMetadata
...
IMPORTANT: When you are done with the iterative process, you MUST provide a final answer OUTSIDE of code blocks (not inside ```repl```). You have two options:
1. FINAL(literal text) — returns the text verbatim. Only for short inline answers.
2. FINAL_VAR(variable_name) — resolves the named variable from the REPL and returns its value. Use this when your answer is in a variable.
WARNING: FINAL(my_var) does NOT resolve the variable — it returns the literal string "my_var". If your answer is in a variable, you MUST use FINAL_VAR.
